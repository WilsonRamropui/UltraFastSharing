<div align="center">
  <!-- TODO: Drop a logo.png in the assets folder! -->
  <!-- <img src="assets/logo.png" height="120" alt="UltraFastSharing Logo"> -->
  
  <h1>⚡ UltraFastSharing v1.2.0</h1>
  <p><strong>A cutting-edge, secure, 100% offline, peer-to-peer (P2P) file transfer utility.</strong></p>
...
<div align="center">
  <img src="assets/Picture.png" alt="UltraFastSharing Screenshot" width="100%" style="max-width: 800px; border-radius: 12px; box-shadow: 0 10px 30px rgba(0,0,0,0.5);">
</div>

<br/>

**UltraFastSharing** bridges the gap between your PC and any mobile device. Built for maximum speed, absolute privacy, and offline capability, it allows you to transfer unlimited file sizes across your local network (Wi-Fi or USB tethering) without ever touching the cloud.
...
*   **📱 Universal Access (Phone or PC):** No app required on the receiving device. Just scan the QR code on your phone, or type the local IP address into a second PC's web browser, to instantly access.
*   **💻 PC-to-PC Direct Transfer:** Seamlessly send files between two PC/laptops.
...
### 1. The Setup Installer (Recommended for Windows)
A full, professional installation perfect for daily use.
1. Download `UltraFastSharing_Setup_1.2.0.exe`.
...
### 2. The Portable Version (Windows)
A standalone executable perfect for USB drives or strict environments.
1. Download `UltraFastSharing_Portable_1.2.0.exe`.
2. Double-click to run it instantly. No installation required.

### 3. macOS Version (Apple Silicon/Intel)
A native disk image for Mac users.
1. Download `UltraFastSharing-1.0.0-arm64.dmg`.
2. Double-click to mount the disk image.
3. Drag and drop the `UltraFastSharing` app into your `/Applications` folder.
4. *Note: You may need to bypass Gatekeeper on first launch by right-clicking the app and selecting "Open".*
